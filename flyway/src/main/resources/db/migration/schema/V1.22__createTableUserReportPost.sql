...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='포스트 신고 유저 테이블';
create unique index user_report_post_post_id_user_id_uindex
    on user_report_post (post_id, user_id);